...
lang : {
	...
	fullExpandText : '1:1',
	number: 'Image %1 of %2',
	restoreTitle : 'Ấn chuột trái để đóng ảnh, Giữ chuột trái và kéo để di chuyển ảnh' //'Click to close image, click and drag to move. Use arrow keys for next and previous.'
},

...
function runTheTicker()
{
	...
	if (theTargetLink ) {
		...
		if (NS6) {
	document.getElementById("theTicker").innerHTML  = '<a style="position:absolute;;left:60px;top:5px;" href="'+ theTargetLink +'" target="_top" class="siteNavigation">'+textTitle+'</a>';
				 }
		else {
	document.all.theTicker.innerHTML  = '<a  style="position:absolute;left:60px;top:5px;" href="'+ theTargetLink +'" target="_top" class="siteNavigation">'+textTitle+'</a>';
				}
						}
	else {
		if (NS6) {
